---
title: Button
last_edited: '2026-04-03T20:35:32.404Z'
...
<imagePlaceholder imageId="cv-button_action--destructive--not-pruimary" />
...
Demos (Covalent / Knapsack): Text, Outlined, and Raised variants are documented in the [Covalent design system — Button Storybook](https://teradata.github.io/covalent/docs/components/?path=/docs/components-button--overview).
