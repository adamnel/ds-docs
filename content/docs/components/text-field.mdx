...
* [Angular Material component](https://material.angular.io/components/input/overview)
* [Figma component](https://www.figma.com/design/KvXVAmYdCVAS7hzkOa73Em/Covalent-Principles?node-id=8054-37781)
...
## Web components
<storybookEmbed storyId="components-text-field--basic" height={300} embedMode="story" />
...
| `type` | Input type (text, search, tel, url, email, password, date, month, week, time, datetime-local, number, color) |
| `label` | Label text |
| `name` | Name attribute |
| `placeholder` | Placeholder text |
| `helper` | Helper text |
| `helperPersistent` | Keep helper text visible |
...
| `charCounter` | Show character counter |
| `validity` | Validity state |
| `autoValidate` | Auto-validate on change |
| `validationMessage` | Custom validation message |
| `willValidate` | Whether the field will validate |
| `validityTransform` | Custom validity transform |
| `validateOnInitialRender` | Validate on initial render |
...
* [Material accessibility component guidelines](https://m2.material.io/components/text-fields)
